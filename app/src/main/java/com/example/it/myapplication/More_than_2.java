...
public class More_than_2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_more_than_2);
    ...
    protected void showList() {
        try {
            ...
            ListAdapter adapter = new SimpleAdapter(
                    More_than_2.this, personList, R.layout.list_item,
    ...
    public void getData(){
        class GetDataJSON extends AsyncTask<String, Void, String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loadingDialog = ProgressDialog.show(More_than_2.this, "Please wait", "Loading...");
            }

            @Override
            protected String doInBackground(String... params) {
                DefaultHttpClient httpclient = new DefaultHttpClient(new BasicHttpParams());
                HttpPost httppost = new HttpPost("http://asr.mkce.ac.in/getdata1.php");
